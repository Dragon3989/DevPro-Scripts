...
function c14470845.initial_effect(c)
	...
	e2:SetCost(c14470845.spcost)
	e2:SetTarget(c14470845.sptg)
	e2:SetOperation(c14470845.spop)
	c:RegisterEffect(e2)
end
function c14470845.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c14470845.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if not Duel.IsPlayerCanSpecialSummonMonster(tp,14470847,0xf,0x4011,0,1000,2,RACE_BEAST,ATTRIBUTE_LIGHT,POS_FACEUP_DEFENSE,1-tp) then return end
	for i=1,2 do
