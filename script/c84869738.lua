...
function c84869738.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then
		...
		if Duel.GetLocationCount(tp,LOCATION_MZONE)>-1 then loc=loc+LOCATION_EXTRA end
...
function c84869738.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	repeat
		...
		ct=ct-1
	until ct==0 or sg:GetCount()==0 or not Duel.SelectYesNo(tp,aux.Stringid(84869738,0))
