...
function c51205763.initial_effect(c)
	...
	e2:SetCountLimit(1,51205763+100)
...
function c51205763.filter(c,e,tp)
	return c:IsSetCard(0x204) and not c:IsCode(51205763) and (c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP_ATTACK) or c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEDOWN_DEFENSE))
end
...
function c51205763.filter1(c,e,tp)
	return c:IsSetCard(0x204) and not c:IsCode(51205763) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
